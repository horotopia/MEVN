...
async function fetchUserAddress() {
  ...
  try {
    ...
    if (!response.ok) {
      throw new Error('Erreur lors de la récupération de l\'adresse utilisateur.');
    }
    ...
    if (Array.isArray(addressData) && addressData.length > 0) {
      ...
      console.error('Aucune donnée d\'adresse disponible');
    }
              ...
              <div class="w-full sm:w-1/2">
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-normal text-black focus:border-primary focus-visible:outline-none"
                    type="text"
                    name="fullName"
                    id="fullName"
                  />
