<template>
    <div>
            ...
            <div class="elements-wraper">
                <div class="plusbox-container">
                    <label class="plusbox">
                        ...
                        >
                            <g fill="none">
                                <path d="M12 1C5.925 1 1 5.925 1 12s4.925 11 11 11s11-4.925 11-11S18.075 1 12 1zm1 15a1 1 0 1 1-2 0v-3H8a1 1 0 1 1 0-2h3V8a1 1 0 1 1 2 0v3h3a1 1 0 1 1 0 2h-3v3z" 
                                    fill="currentColor"/>
                            </g>
                        </svg>
                ...
                <div v-for="(image, index) in savedMedia" :key="index" class="image-container">
                    <img :src="location +'/'+ image.name" alt=""  class="images-preview">
                    <button @click="removeSavedMedia(index)" class="close-btn" type="button">
                        <svg
                            class='times-icon'
                            xmlns="http://www.w3.org/2000/svg"
                            width="0.65em"
                ...
                <div v-for="(image, index) in addedMedia" :key="index" class="image-container">
                    <img :src="image.url" alt=""  class="images-preview">
                    <button @click="removeAddedMedia(index)" class="close-btn" type="button">
                        <svg
                            class='times-icon'
                            xmlns="http://www.w3.org/2000/svg"
                            width="0.65em"
        ...
        <div>
            <div v-for="(image, index) in addedMedia" :key="index" class="mt-1">
                <input type="text" name="added_media[]" :value="image.name" hidden>
            </div>
            <div v-for="(image, index) in removedMedia" :key="index" class="mt-1">
                <input type="text" name="removed_media[]" :value="image.name" hidden>
            </div>
            <div v-if="allMedia.length" class="mt-1">
