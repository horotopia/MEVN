...
//   describe('createCart', () => {
//     it.skip('should create a new cart successfully', async () => {
//       const mockCart = {
...
//     it.skip('should find a cart by id', async () => {
//       const mockCart = {
...
//     it.skip('should return null if cart not found', async () => {
...
//     it.skip('should find all carts by user id', async () => {
//       const mockCarts = [
//         {
//           _id: '507f191e810c19729de860ea',
//           userId: '507f191e810c19729de860eb',
...
//   describe('updateCart', () => {
//     it.skip('should update a cart successfully', async () => {
//       const mockCart = {
//         _id: '507f191e810c19729de860ea',
//         userId: '507f191e810c19729de860eb',
//         items: [
...
//   describe('deleteCart', () => {
//     it.skip('should delete a cart successfully', async () => {
//       const mockCart = {
//         _id: '507f191e810c19729de860ea',
//         userId: '507f191e810c19729de860eb',
//         items: [
...
//     it.skip('should delete all carts by user id successfully', async () => {
