...
//     it.skip('should create a new product successfully', async () => {
...
//     it.skip('should return null if product not found', async () => {
...
//     it.skip('should throw an error if product not found', async () => {
...
//     it.skip('should delete a product successfully', async () => {
//       const mockProduct = {
//         _id: '507f191e810c19729de860ea',
//         name: 'Pikachu',
//         description: 'Pokémon électrique',
