...
//     it.skip('should create a new favoris successfully', async () => {
//       const mockFavoris = {
...
//     it.skip('should find a favoris by id', async () => {
//       const mockFavoris = {
...
//     it.skip('should return null if favoris not found', async () => {
...
//     it.skip('should find all favoris by user id', async () => {
...
//     it.skip('should delete a favoris successfully', async () => {
//       const mockFavoris = {
//         _id: '507f191e810c19729de860ea',
//         userId: '507f191e810c19729de860eb',
//         productId: '507f191e810c19729de860ec',
...
//     it.skip('should delete all favoris by user id successfully', async () => {
