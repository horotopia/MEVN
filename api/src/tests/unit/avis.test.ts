...
describe('AvisService', () => {
  ...
  describe('createAvis', () => {
    it('should create a new avis successfully', async () => {
      const mockAvis = {
  ...
  describe('findAllAvisByProductId', () => {
    it('should find all avis by product id', async () => {
      const mockAvisList = [
        {
  ...
  describe('findAllAvisByUserId', () => {
    it('should find all avis by user id', async () => {
      const mockAvisList = [
        {
          _id: '507f191e810c19729de860ea',
          userId: '507f191e810c19729de860eb',
  ...
  describe('updateAvis', () => {
    it('should update an avis successfully', async () => {
      const mockAvis = {
        _id: '507f191e810c19729de860ea',
        userId: '507f191e810c19729de860eb',
        productId: '507f191e810c19729de860ec',
    ...
    it('should return null if avis not found', async () => {
  ...
  describe('deleteAvis', () => {
    it('should delete an avis successfully', async () => {
      const mockAvis = {
        _id: '507f191e810c19729de860ea',
        userId: '507f191e810c19729de860eb',
        productId: '507f191e810c19729de860ec',
    ...
    it('should throw an error if avis not found', async () => {
  ...
  describe('anonymise', () => {
    it('should anonymise avis successfully', async () => {
